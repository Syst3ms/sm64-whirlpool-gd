...
#define OVERSMOOTH_FAC 0.5
#define MAX_YAW_SPEED (OVERSMOOTH_FAC*(5*M_PI/256))
#define MAX_YAW_SPEED_SQUARED (MAX_YAW_SPEED * MAX_YAW_SPEED)
#define BASE_MEM_SIZE 100
#define MEM_STORE_RATE 500
#define BETA_1 0.9
#define BETA_2 0.999
#define MIN_CONSTRAINT_PROGRESS 0.99
#define CONSTRAINT_UPSCALE 1.25
#define EPS_DOWNSCALE 0.8
